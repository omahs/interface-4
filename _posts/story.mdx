...
- enhance composability with other smart contracts and platforms
...
And to support the project, head to the [Slice DAO treasury on Juicebox ✨](https://juicebox.money/#/p/slice) — you'll find the nitty-gritty details on the JB treasury in [this blog post](/blog/treasury).
