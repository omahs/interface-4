...
export interface SliceCoreDummyInterface extends utils.Interface {
  contractName: "SliceCoreDummy";
  functions: {
...
export interface SliceCoreDummy extends BaseContract {
  contractName: "SliceCoreDummy";
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: SliceCoreDummyInterface;
