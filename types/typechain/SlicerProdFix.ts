...
export interface SlicerProdFixInterface extends utils.Interface {
  contractName: "SlicerProdFix";
  functions: {
  ...
  decodeFunctionResult(functionFragment: "reddropFix", data: BytesLike): Result;
...
export interface SlicerProdFix extends BaseContract {
  contractName: "SlicerProdFix";
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: SlicerProdFixInterface;
  ...
  callStatic: {
    ...
    reddropFix(overrides?: CallOverrides): Promise<void>;
