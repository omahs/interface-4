...
export interface TickMathLiteInterface extends utils.Interface {
  contractName: "TickMathLite";
  functions: {
    "MAX_TICK()": FunctionFragment;
    "getCurrencyPrice(address,uint256)": FunctionFragment;
...
export interface TickMathLite extends BaseContract {
  contractName: "TickMathLite";
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: TickMathLiteInterface;
