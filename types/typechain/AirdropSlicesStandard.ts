...
export interface AirdropSlicesStandardInterface extends utils.Interface {
  contractName: "AirdropSlicesStandard";
  functions: {
    "_closeAirdrop()": FunctionFragment;
    "_setParams(address,bytes32,uint256,uint256,uint256)": FunctionFragment;
  ...
  events: {
    ...
    "ParamsSet(address,bytes32,uint256,uint256,uint256)": EventFragment;
  };
...
export type ParamsSetEvent = TypedEvent<
  [string, string, BigNumber, BigNumber, BigNumber],
  {
    ...
    claimSlicesAmount: BigNumber;
  }
>;

export type ParamsSetEventFilter = TypedEventFilter<ParamsSetEvent>;

export interface AirdropSlicesStandard extends BaseContract {
  contractName: "AirdropSlicesStandard";
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: AirdropSlicesStandardInterface;
  ...
  callStatic: {
    ...
    claim(proof: BytesLike[], overrides?: CallOverrides): Promise<void>;
  ...
  filters: {
    ...
    "ParamsSet(address,bytes32,uint256,uint256,uint256)"(
      collector?: null,
      merkleRoot?: null,
      whitelistPrice?: null,
      whitelistStartDate?: null,
      claimSlicesAmount?: null
