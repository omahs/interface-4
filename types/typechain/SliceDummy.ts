...
export interface SliceDummyInterface extends utils.Interface {
  contractName: "SliceDummy";
  functions: {
...
export interface SliceDummy extends BaseContract {
  contractName: "SliceDummy";
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: SliceDummyInterface;
