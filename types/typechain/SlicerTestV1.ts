...
export declare namespace SlicerProducts {
  ...
  export type FunctionStructOutput = [string, string, BigNumber] & {
    contractAddress: string;
...
export interface SlicerTestV1Interface extends utils.Interface {
  contractName: "SlicerTestV1";
  functions: {
  ...
  events: {
    ...
    "ProductAdded(uint32,uint32,uint256,bool,bool,bool,uint32,address,bytes,uint256[],uint32[],tuple)": EventFragment;
...
export type ProductAddedEvent = TypedEvent<
  [
    ...
    BigNumber[],
    number[],
    SlicerProducts.FunctionStructOutput
  ],
  {
    productId: number;
    ...
    subProducts: number[];
    externalCall: SlicerProducts.FunctionStructOutput;
  }
>;
...
export interface SlicerTestV1 extends BaseContract {
  contractName: "SlicerTestV1";
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: SlicerTestV1Interface;
  ...
  filters: {
    ...
    "ProductAdded(uint32,uint32,uint256,bool,bool,bool,uint32,address,bytes,uint256[],uint32[],tuple)"(
