  ...
  return (
    <div className="isolate">
      ...
      <main className="relative">
        <div className="max-w-4xl mx-auto mt-48 mb-32">
          ...
          <div className="max-w-2xl px-4 mx-auto text-center md:px-0">
            ...
            <div className="flex items-center justify-center mt-10 gap-x-6">
              ...
              <Link
                href="/slicer"
                className="flex w-24 space-x-1.5 text-base font-semibold leading-7 text-gray-900 group"
              >
                <p>Explore</p>{" "}
                <p
                  aria-hidden="true"
        ...
        <div className="absolute inset-x-0 top-[calc(100%-25rem)] -z-10 transform-gpu overflow-x-hidden blur-3xl sm:top-[calc(100%-30rem)]">
          <svg
            className="relative left-[calc(50%+3rem)] h-[25.1875rem] max-w-none -translate-x-1/2 sm:left-[calc(50%+36rem)] sm:h-[42.375rem]"
            viewBox="0 0 1155 678"
            xmlns="http://www.w3.org/2000/svg"
          >
            <path
